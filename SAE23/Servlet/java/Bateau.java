...
public class Bateau extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (idbParam == null || idbParam.isEmpty()) {
                out.println("<p style='color:red;'>Paramètre 'idb' manquant. Exemple : /Bateau?idb=10</p>");
            } else {
                try {
                    ...
                    try (Connection conn = ds.getConnection()) {
                        ...
                        if (result.next()) {
                            String nombateau = result.getString("nombateau");
                            out.println("<h1>Palmarès du bateau " + nombateau + "</h1>");

                            out.println("<table border='1'>");
                            out.println("<thead>");
                            out.println("<tr><th>Place</th><th>Skipper</th><th>Édition</th></tr>");
                            out.println("</thead>");
                            out.println("<tbody>");
                            ...
                            out.println("<p style='color:red;'>Aucun résultat pour ce bateau.</p>");
                        }
                    ...
                    out.println("<p style='color:red;'>Paramètre 'idb' invalide.</p>");
    ...
    public String getServletInfo() {
        return "Servlet affichant le palmarès d'un bateau en HTML";
    }
}